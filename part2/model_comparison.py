...
fraction_pos_lr, mean_pred_lr = calibration_curve(
...
fig.suptitle(
    "Threshold Analysis — Why 0.5 is Not the Optimal Cut-off\n(Imbalanced classes require threshold tuning based on business cost)",
    fontsize=12,
    fontweight="bold",
)
fig.patch.set_facecolor("white")
...
ax.set_title(
    "Model Performance Comparison — Full Metric Suite", fontsize=13, fontweight="bold", pad=20
)
fig.patch.set_facecolor("white")
plt.tight_layout()
